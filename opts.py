...
def parse_args():
    parser = argparse.ArgumentParser(description='CLARE.py')
    ...
    parser.add_argument('--dataset', type=str, required=True, help='Name of dataset', choices=['MNIST', 'CIFAR10', 'CIFAR100', 'SVHN', 'TinyImagenet', 'ImageNet100', 'ImageNet', 'CUB200'])
    ...
    parser.add_argument('--model', type=str, default='CLIP', choices=['CLIP'], help='Model architecture')
    ...
    parser.add_argument('--scenario', type=str, default='unrealistic', help='Continual learning scenario', choices=['unrealistic', 'semirealistic', 'realistic'])
    parser.add_argument('--seed', type=int, default=1000, help='Seed for reproducibility of class-setting etc')
    parser.add_argument('--exp_name', type=str, default='test', help='Experiment name')
    parser.add_argument('--old_exp_name', type=str, default='ci100_test_batch64', help='Name of experiment to take pretrained model from')
    parser.add_argument('--finetune', type=str, default='False',help = 'Enable or disable fine-tuning', choices=['False', 'True'])

    # Default experiment options
    parser.add_argument('--maxlr', type=float, default=0.005, help='Starting Learning rate')
    parser.add_argument('--minlr', type=float, default=0.0005, help='Ending Learning rate')
    parser.add_argument('--weight_decay', type=float, default=1e-4, help='Weight decay')
    parser.add_argument('--batch_size', type=int, default=64, help='Batch size to be used in training')
